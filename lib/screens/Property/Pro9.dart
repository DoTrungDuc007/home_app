...
import 'package:sewaa/screens/View/View9.dart';

class Pro9 extends StatefulWidget {
  List<PropertyDetail> propertyDetails;
  Pro9({this.propertyDetails});
  @override
  _PropertyDetailScreenState createState() => _PropertyDetailScreenState();
}

class _PropertyDetailScreenState extends State<Pro9> {
  @override
